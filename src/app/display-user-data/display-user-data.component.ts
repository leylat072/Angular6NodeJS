...
export class DisplayUserDataComponent implements OnInit
{
	...
	constructor(private http: HttpClient, private route: ActivatedRoute, private httpClientModule: HttpClientModule) {
	...
	ngOnInit()
	{
		this.subscriber = this.route.params.subscribe(params => {
	       ...
	       this.http.get('http://localhost:3000/api/customer/' + params.uid).subscribe((data:any) => {
