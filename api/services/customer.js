...
let customers = [{uid : 'cust2dsa12dsa', guid :'cust2dsa12dsa', first_name :'leyla',last_name :'taghavi',
email :'ltaghavi@cisii.org', zipcode :'123345', password:'dff' }];
let counter = 0;
...
class CustomerService
{
	...
	static retrieve(uid)
	{
		//console.log('retrive leyla',customers,uid );
		let cus = customers.find(c => c.uid == uid);
		console.log('retrive leyla',customers[uid] );
		if(cus != null)
		{
			return cus;
